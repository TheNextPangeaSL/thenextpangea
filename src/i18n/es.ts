export const es = {
  ...
  "frt.hero.tag2": "Digitalización",
  "frt.hero.tag3": "Trazabilidad",
  "frt.hero.title": '<span class="product-gradient-text">Digitalización integral</span> de informes de Ensayos No Destructivos',
  "frt.hero.subtitle": "Digitaliza y automatiza la elaboración de informes END: desde la ODM y la evidencia del ensayo hasta el PDF final, con control de máquinas, trazabilidad y firma.",
  "frt.hero.chip1": "Informes END automatizados",
  "frt.hero.chip2": "Control de equipos",
  "frt.hero.chip3": "Evidencias integradas",
  "frt.hero.chip4": "Firma y trazabilidad",
  "frt.hero.cta.primary": "Solicitar más información",

  // FAST REPORTING TOOL — El reto
  "frt.challenge.label": "El reto operativo",
  "frt.challenge.title": 'Los informes END son <span class="product-gradient-text">manuales, lentos y difíciles de trazar</span>',
  "frt.challenge.p1": 'En la inspección mediante Ensayos No Destructivos, la generación del informe final es un proceso <strong class="font-semibold">manual, repetitivo y propenso a errores</strong>. Los inspectores deben registrar datos de la orden de trabajo, los equipos utilizados, las evidencias fotográficas y los hallazgos, consolidándolo todo en un documento que debe cumplir plantillas y estándares estrictos.',
  "frt.challenge.p2": "No existe un mecanismo que garantice que se han realizado todos los ensayos requeridos, que los equipos utilizados están calibrados o que las evidencias fotográficas están completas antes de emitir el informe.",
  "frt.challenge.p3": 'Cada inspección implica <strong class="font-semibold text-slate-700">recopilar información dispersa</strong>, rellenar plantillas a mano, adjuntar fotografías y obtener firmas, con riesgo de omisiones que pueden comprometer la validez del informe o generar no conformidades en auditoría.',
  "frt.challenge.p4": 'El reto no es solo generar el documento: es <strong class="font-semibold text-slate-700">digitalizar y estandarizar todo el flujo</strong>, desde la orden de trabajo hasta el PDF firmado, con control de equipos, evidencias integradas y trazabilidad completa.',

  // FAST REPORTING TOOL — La solución
  "frt.solution.label": "La solución",
  "frt.solution.title": 'Digitalización <span class="product-gradient-text">de principio a fin</span> del informe END',
  "frt.solution.p1": '<strong class="font-semibold text-slate-700">Fast Reporting Tool</strong> digitaliza y automatiza la generación de informes de Ensayos No Destructivos (END) de principio a fin. A partir del escaneo de la orden de trabajo, guía al inspector en un <strong class="font-semibold text-slate-700">flujo estandarizado</strong>: propone los ensayos aplicables, valida el uso de equipos (disponibilidad y calibración), solicita la evidencia fotográfica requerida y permite registrar anomalías de forma estructurada.',
  "frt.solution.p2": "Con esa información, el sistema rellena automáticamente plantillas de informe y genera el PDF listo para revisión y firma por perfiles autorizados.",
  "frt.solution.p3": "El resultado es un proceso más rápido y consistente, con menos errores manuales, mayor trazabilidad y un repositorio centralizado de informes y evidencias para auditorías y consultas.",
  "frt.solution.bullet1": "Automatización del informe END: desde la ODM y la evidencia del ensayo hasta el PDF final, con plantillas estandarizadas.",
  "frt.solution.bullet2": "Flujo guiado y homogéneo: propone ensayos aplicables y asegura que el registro siga un proceso consistente.",
  "frt.solution.bullet3": "Control de equipos y calibración: valida disponibilidad y estado del equipo para evitar usos no conformes.",
  "frt.solution.bullet4": "Evidencias y anomalías integradas: captura fotográfica requerida y documentación estructurada de defectos/observaciones.",
  "frt.solution.bullet5": "Firma, trazabilidad y archivo: revisión y firma por roles autorizados, con histórico centralizado para auditoría y búsqueda.",
  "frt.solution.workflow.title": "Flujo de generación de informes END",
  ...
  // FAST REPORTING TOOL — Características principales
  "frt.features.label": "Características principales",
  "frt.features.title": 'Todo el ciclo END <span class="product-gradient-text">digitalizado y bajo control</span>',
  "frt.features.subtitle": "Desde la orden de trabajo hasta el PDF firmado: flujo guiado, control de equipos, evidencias integradas y trazabilidad completa.",
  "frt.features.f1.title": "Automatización del informe END",
  "frt.features.f1.desc": "Desde la ODM y la evidencia del ensayo hasta el PDF final, con plantillas estandarizadas que garantizan consistencia y reducen errores manuales.",
  "frt.features.f2.title": "Flujo guiado y homogéneo",
  "frt.features.f2.desc": "Propone los ensayos aplicables según la orden de trabajo y asegura que el registro siga un proceso consistente y estandarizado en cada inspección.",
  "frt.features.f3.title": "Control de equipos y calibración",
  "frt.features.f3.desc": "Valida la disponibilidad y el estado de calibración de los equipos antes de cada ensayo, evitando usos no conformes y asegurando la validez del resultado.",
  "frt.features.f4.title": "Evidencias y anomalías integradas",
  "frt.features.f4.desc": "Captura fotográfica requerida por el procedimiento y documentación estructurada de defectos y observaciones, todo vinculado al informe correspondiente.",
  "frt.features.f5.title": "Firma, trazabilidad y archivo",
  "frt.features.f5.desc": "Revisión y firma por perfiles autorizados, con histórico centralizado de informes y evidencias para auditorías, búsquedas y consultas posteriores.",
  ...
  "frt.defense.app1.desc": "Digitalización de informes de inspección END para operaciones de seguridad, con trazabilidad completa de ensayos, equipos utilizados y evidencias capturadas, garantizando la conformidad documental.",
  "frt.defense.app2.code": "AF6",
  "frt.defense.app2.title": "Sostenimiento y mantenimiento",
  "frt.defense.app2.desc": "Automatización del reporting de ensayos no destructivos en programas de sostenimiento: control de calibración, registro estructurado de hallazgos y archivo centralizado para auditoría y consulta.",
  "frt.defense.app3.code": "AF3",
  "frt.defense.app3.title": "GIC y control de calidad",
  "frt.defense.app3.desc": "Estandarización y automatización de informes de inspección para asegurar la calidad de procesos y componentes, con flujos guiados que garantizan la homogeneidad del registro y la trazabilidad de resultados.",
  "frt.defense.capacidad.code": "Capacidad diferencial",
  "frt.defense.capacidad.title": "De la ODM al PDF firmado, sin papel ni errores manuales",
  "frt.defense.capacidad.desc": "Fast Reporting Tool digitaliza y automatiza el ciclo completo de generación de informes END: desde el escaneo de la orden de trabajo hasta el PDF final firmado. Guía al inspector en un flujo estandarizado, valida equipos, captura evidencias y genera documentación consistente con trazabilidad total.",
  ...
  "frt.cta.desc": "Analizamos tus procedimientos de inspección END y tipos de informe para configurar flujos, plantillas y controles adaptados a tu operación.",
