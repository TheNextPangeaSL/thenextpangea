export const es = {
  ...
  "products.pageSubtitle": "Soluciones aplicadas de inteligencia artificial, edge computing, ciencia de materiales y biotecnología. Accede a fichas de producto para conocer capacidades, aplicaciones y casos de uso.",
  ...
  "products.nav.ia": "IA / Software",
  "products.nav.edge": "Edge AI",
  ...
  "products.section.ia.desc": "Plataformas software basadas en IA para planificación de recursos, inteligencia documental, analítica avanzada y visión artificial desplegable.",
  "products.section.edge.label": "Edge AI",
  "products.section.edge.title": "Inteligencia desplegable en el borde",
  "products.section.edge.desc": "Ejecución de modelos IA cerca del sensor: menor latencia, menor dependencia de red y operación robusta en entornos exigentes.",
  "products.section.materiales.label": "Ciencia de Materiales & Fabricación Avanzada",
  "products.section.materiales.title": "Funcionalidad avanzada e industrialización",
  "products.section.materiales.desc": "Materiales funcionales, sensórica, electrónica impresa y fabricación aditiva para entornos exigentes: integración estructural, bajo perfil, repetibilidad y despliegue en condiciones reales.",
