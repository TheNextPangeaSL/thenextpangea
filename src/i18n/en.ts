export const en = {
  ...
  "heaters.applications.title": 'Optimized for <span class="product-gradient-text">demanding</span> applications',
  "heaters.applications.subtitle": "From anti-icing on leading edges to pre-taping tables and AFP systems with stability, repeatability and uniformity control requirements.",
  "heaters.applications.app1.title": "Leading edge anti-icing",
  "heaters.applications.app1.desc": "Integrated heating for ice formation prevention on critical aerodynamic surfaces.",
  "heaters.applications.app2.title": "Pre-taping tables",
  "heaters.applications.app2.desc": "Temperature-controlled work surfaces for composite layup and forming processes.",
  "heaters.applications.app3.title": "AFP systems and repair",
  "heaters.applications.app3.desc": "Thermal integration in automated fiber placement systems and composite repair with controlled curing.",
