export const en = {
  ...
  "products.pageSubtitle": "Applied solutions in artificial intelligence, edge computing, materials science and biotechnology. Access product sheets for capabilities, applications and use cases.",
  ...
  "products.section.ia.title": "Quantitative decision-making, automation and vision",
  "products.section.ia.desc": "AI-based software platforms for resource planning, document intelligence, advanced analytics, and deployable computer vision.",
  "products.section.edge.label": "Edge AI",
  "products.section.edge.title": "Deployable intelligence at the edge",
  "products.section.edge.desc": "AI model execution close to the sensor: lower latency, reduced network dependency and robust operation in demanding environments.",
  "products.section.materiales.label": "Materials Science & Advanced Manufacturing",
  "products.section.materiales.title": "Advanced functionality and industrialization",
  "products.section.materiales.desc": "Functional materials, sensorics, printed electronics, and additive manufacturing for demanding environments: structural integration, low profile, repeatability and real-world deployment.",
